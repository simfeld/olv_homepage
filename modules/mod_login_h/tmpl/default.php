...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline">
	...
	<!--div class="userdata"-->
		...
		<td><div id="form-login-password" class="control-group">
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
						<span class="add-on">
		...
		<td><div id="form-login-secretkey" class="control-group">
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
		...
		<!--td><div id="form-login-remember" class="control-group checkbox">
		...
		<?php endif; ?>
		<td><div id="form-login-submit" class="control-group">
			<div class="controls">
